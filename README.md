...
| [`@schally/nestjs-messenger-transport-kafka`](packages/transport-kafka) | Apache **Kafka** transport (`kafkajs`). Offset-commit acks; no native delay; not a failure-inspection backend. |
